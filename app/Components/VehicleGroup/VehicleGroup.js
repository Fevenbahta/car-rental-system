...
const vehicles = [
  {
    ...
    seats: "5 Seats",
    price: 2500,
    image: { src: "https://via.placeholder.com/600x400?text=Toyota+Corolla" },
    availability: true,
    type: "Sedan",
  },
  {
    ...
    seats: "5 Seats",
    price: 3000,
    image: { src: "https://via.placeholder.com/600x400?text=Hyundai+Tucson" },
    availability: true,
    type: "SUV",
  },
  {
    ...
    seats: "4 Seats",
    price: 2000,
    image: { src: "https://via.placeholder.com/600x400?text=Suzuki+Swift" },
    availability: false,
    type: "Hatchback",
  },
];
